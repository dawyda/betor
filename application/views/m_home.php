...
<link rel="stylesheet" href="<?=base_url();?>assets/css/m_home.css" type="text/css" media="screen" />
<link rel="stylesheet" href="<?=base_url();?>assets/css/m_menu_bar.css" type="text/css" media="screen" />
<link rel="stylesheet" href="<?=base_url();?>assets/css/m_table.css" type="text/css" media="screen" />
<link rel="stylesheet" href="<?=base_url();?>assets/css/m_bottom_footer.css" type="text/css" media="screen" />
    	...
    	<div id="top-head">
        	<div id="top-nav">
            	<ul>
                    ...
                    <li><a href="#" style="border:none; color:#f7ef00; max-width:150px;">M-Pesa to 0712594022</a></li>
                </ul>
            </div>
            <div class="clear"></div>
            <div id="main-nav">
            ...
            <div id="login"><span id="ndevo"></span>
            	...
            	<!--<form id="login_form" method="post" action="login">-->
                    <div class="log-hold">
                	<label for="email" style="color:#f7ef00; font-size:13px;">Username:</label><br />
                	<input type="text" id="email" name="username" class="txt" required="required" placeholder="username" />
                    </div>
                    <div class="log-hold">
                    <label for="password" style="color:#f7ef00; font-size:13px;">Password:</label><br />
                    <input type="password" id="password" name="password" class="txt" required="required" placeholder="********" />
                    </div>
                    <div class="log-hold">
