...
<body>
 <div id="cont">
		...
		<span style="font-weight:bold; text-decoration:underline; margin-bottom10px; display:block;">Free Tip 1.</span><br />
		<label>Matchdate: </label><input type="text" name="matchdate1" id="matchdate1" placeholder="mm-dd h:m" style="margin-right:20px;" />
		...
		<label>Weight: </label><input type="text" name="weight1" id="weight1" placeholder="1 - 10" /><br/><br/>
		<label>Home: </label><input type="text" name="home1" id="home1" style="margin-right:20px;"  />
		<label>Draw: </label><input type="text" name="draw1" id="draw1" style="margin-right:20px;"  />
		<label>Away: </label><input type="text" name="away1" id="away1" /><br/><br/>
		...
		<span style="font-weight:bold; text-decoration:underline; margin-bottom10px; display:block;">Free Tip 2.</span><br />
		<label>Matchdate: </label><input type="text" name="matchdate2" id="matchdate2" placeholder="mm-dd h:m" style="margin-right:20px;" />
		...
		<label>Weight: </label><input type="text" name="weight2" id="weight2" placeholder="1 - 10" /><br/><br/>
		<label>Home: </label><input type="text" name="home2" id="home2" style="margin-right:20px;"  />
		<label>Draw: </label><input type="text" name="draw2" id="draw2" style="margin-right:20px;"  />
		<label>Away: </label><input type="text" name="away2" id="away2" /><br/><br/>
		...
		<span style="font-weight:bold; text-decoration:underline; margin-bottom10px; display:block;">Free Tip 3.</span><br />
		<label>Matchdate: </label><input type="text" name="matchdate3" id="matchdate3" placeholder="mm-dd h:m" style="margin-right:20px;" />
		<label>Match: </label><input type="text" name="match1" id="match1" placeholder="team a - team b" /><br/><br/>
		<label>Prediction: </label><input type="text" name="prediction3" id="prediction3" style="margin-right:20px;"  />
		<label>Weight: </label><input type="text" name="weight3" id="weight3" placeholder="1 - 10" /><br/><br/>
		<label>Home: </label><input type="text" name="home3" id="home3" style="margin-right:20px;"  />
		<label>Draw: </label><input type="text" name="draw3" id="draw3" style="margin-right:20px;"  />
		<label>Away: </label><input type="text" name="away3" id="away3" /><br/><br/>
