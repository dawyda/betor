 ...
 <div id="cont">
        ...
        <div id="main_cont">
        	<div id="form_left_side">
            	<span style="padding-left:10px;font-family:Arial, Helvetica, sans-serif; font-size:11.5pt;">Already registered? <a class="terms" href="<?=base_url();?>home">Login</a></span><br />
                <div id="black_head">
                ...
                <div class="clear"></div>
                <?=form_open(base_url().'signup/adduser/','id="reg_form" onsubmit="return verify();"');?>
                <!--<form id="reg_form" method="post" action="register.php" onsubmit="return verify();">-->
                    ...
                    <label for="fname">Full Names:</label><input class="txt" type="text" name="fname" id="fname" required="required" value="<?=set_value('fname');?>" />
                    <span class="det_lbl">6-10 characters</span>
                    <label for="username">User Name:</label><input class="txt" type="text" name="username" id="username" required="required" value="<?=set_value('username');?>" />
                    <span class="det_lbl">Min of 6 & max of 14 characters</span>
                    <label for="password">Password:</label><input class="txt" type="password" name="password" id="password" required="required" value="<?=set_value('password');?>" />
                    <label for="pass2">Retype password:</label><input class="txt" type="password" name="pass2" id="pass2" required="required" value="<?=set_value('pass2');?>" />
                    <span class="det_lbl">Used for account confirmation </span>
                    <label for="email">Email:</label><input class="txt" type="email" name="email" id="email" value="" required="required" value="<?=set_value('email');?>" />
                    <span class="det_lbl">Used for account transactions </span>
                    <label for="mobile">Mobile Number:</label><input class="txt" type="text" name="mobile" id="mobile" title="+254-xxx-xxx" required="required" value="<?=set_value('mobile');?>" />
                    <label for="captcha">Enter the text:</label><?php echo $image; ?>
                    <label style="color:#f8f8f8">this is just needed:</label><input style="width:150px;" class="txt" name="captcha" id="captcha" required="required" value="" />
                    <div id="term_sc">
                       ...
                       <span style="color:#686868; font-size:11.8pt; font-family:Arial, Helvetica, sans-serif;">I have read, understood and agreed to the <a class="terms" style="color:#fe1f02;" href="<?=base_url();?>terms" target="_blank">terms of service.</a> I'm ready to have my account created.</span>
